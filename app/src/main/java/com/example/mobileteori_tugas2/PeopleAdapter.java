...
public class PeopleAdapter extends
    ...
    int images[];
    Context context;
    public PeopleAdapter(Context ct, String s1[], String s2[],
                          String s3[], int img[]){
        context = ct;
        data1 = s1;
        data2 = s2;
    ...
    @NonNull
    @Override
    public PeopleAdapter.PeopleViewHolder
    ...
    public void onBindViewHolder(@NonNull
                                             PeopleAdapter.PeopleViewHolder holder, int position) {
    ...
    public class PeopleViewHolder extends
